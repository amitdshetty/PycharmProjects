...
def main():
    ...
    if choiceOfAlgorithm == 1:
        hillclimbingvariants.useSteepHillClimbingApproach(noofQueensOnBoard, numOfIteration)
    elif choiceOfAlgorithm == 2:
        hillclimbingvariants.useSteepHillClimbingApporachWithSidewaysMove(noofQueensOnBoard, numOfIteration)
    elif choiceOfAlgorithm == 3:
        hillclimbingvariants.useRandomRestartHillClimbingApporach(noofQueensOnBoard, numOfIteration)
    else :
